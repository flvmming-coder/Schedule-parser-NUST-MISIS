...
- Global GitHub Pages publication - the department app can publish the current schedule to a public HTTPS page available worldwide.
...
9. For worldwide access, click `Опубликовать в интернет` in `ScheduleDepartmentApp` and use the GitHub Pages URL.
